...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b dark:from-background dark:to-background/90 from-background to-background/90">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-primary hover:bg-primary/90 text-white font-accent"
          ...
          <div>
            <div className="bg-card border border-primary/5 rounded-xl p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@nexdev.com" className="text-primary hover:text-accent transition-colors">hello@nexdev.com</a>
                  </div>
                </div>
                <div className="flex">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mr-4">
