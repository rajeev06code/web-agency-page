...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="absolute top-32 right-10 w-48 h-48 border border-primary/5 animate-rotate" style={{animationDuration: '50s'}}></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="mb-20 max-w-3xl">
          <div className="inline-block mb-4">
            <div className="flex items-center">
              ...
              <span className="text-sm uppercase tracking-widest font-medium text-primary">Contact</span>
            </div>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in">Get in touch<span className="text-primary">.</span></h2>
          <p className="text-xl text-muted-foreground max-w-2xl animate-slide-up animate-delay-100">
            Have a project in mind? Reach out to us and discover how we can help transform your digital vision into reality.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="relative">
            <div className="absolute top-24 -left-4 w-32 h-32 border border-primary/5 animate-rotate" style={{animationDuration: '30s'}}></div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@nexdev.com" className="text-primary hover:underline transition-all">hello@nexdev.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+1234567890" className="text-primary hover:underline transition-all">+1 (234) 567-890</a>
                  </div>
                </div>
