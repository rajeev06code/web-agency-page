  ...
  return (
    <section className="py-20 relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary to-accent rounded-3xl p-10 md:p-16 shadow-2xl">
          <div className="text-center">
            ...
            <Button asChild variant="secondary" className="bg-white hover:bg-opacity-90 text-primary font-accent">
